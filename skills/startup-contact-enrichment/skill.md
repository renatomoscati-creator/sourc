# Startup Contact Enrichment

**Purpose:** Enrich startup database with contact information by scraping company websites and aggregator sites (PoliHub, LinkedIn, etc.).

**Use when:** Startups have websites but missing `contactEmail`, `contactPhone`, or `contactLinkedin` fields.

**Trigger phrases:** "enrich contacts", "scrape contact info", "find startup emails", "update sourcing database"
